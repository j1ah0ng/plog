...
This is an adaptation of a theory presentation I gave while at Cruise in June 2024, motivated by [Liu, Wang et al.'s paper on KANs](https://arxiv.org/pdf/2404.19756v1). The goal is to build intuition rather than mechanical $\varepsilon$-$\delta$ proofs.
